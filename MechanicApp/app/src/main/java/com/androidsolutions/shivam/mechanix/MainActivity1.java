...
import com.androidsolutions.shivam.mechanix.adapter.ColorAdapter;
import com.androidsolutions.shivam.mechanix.adapter.FontsAdapter;
import com.androidsolutions.shivam.mechanix.dialogfragment.ListDialogFragment;
...
public class MainActivity1 extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, SeekBar.OnSeekBarChangeListener {
    ...
    public void onCircColors(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        mConfigSplash.setBackgroundColor(mColorAdapter.getColors().getResourceId(arg2, 7));
    }
